...
export default function LoginPage() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <Suspense fallback={
        <div className="max-w-md w-full bg-white p-10 rounded-[3rem] shadow-xl border border-zinc-50 text-center relative z-10">
          <div className="animate-pulse flex flex-col items-center">
            <div className="w-20 h-20 bg-zinc-100 rounded-[2rem] mb-6"></div>
            <div className="h-8 bg-zinc-100 w-48 rounded mb-4"></div>
            <div className="h-4 bg-zinc-100 w-32 rounded"></div>
          </div>
        </div>
      }>
        <LoginForm />
